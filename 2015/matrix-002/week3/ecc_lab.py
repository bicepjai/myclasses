...
encoding_1001 = list((G * Vec({0,1,2,3},{0:one, 1:0, 2:0, 3:one})).f.values())


## Task 3
# Express your answer as an instance of the Mat class.
R = listlist2mat([list(solve(G,Vec(set(range(7)),{i:one})).f.values()) for i in set(range(7))]).transpose()
...
## Task 9
C = (P.transpose() * G.transpose()).transpose()
