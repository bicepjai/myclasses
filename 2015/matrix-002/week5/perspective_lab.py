...
def make_nine_equations(corners):
    ...
    >>> rl = make_nine_equations(((12,13),(14,15),(16,17),(18,19)))
    >>> rl[0] == Vec({('y2', 'x2'), ('y1', 'x3'), ('y3', 'x2'), ('y1', 'x1'), ('y2', 'x1'), ('y3', 'x3'), ('y1', 'x2'), ('y3', 'x1'), ('y2', 'x3')},{('y3', 'x3'): 0, ('y2', 'x2'): 0, ('y1', 'x3'): -1, ('y1', 'x2'): -13, ('y3', 'x1'): 0, ('y1', 'x1'): -12, ('y2', 'x1'): 0, ('y3', 'x2'): 0, ('y2', 'x3'): 0})
    True
    >>> rl[1] == Vec({('y2', 'x2'), ('y1', 'x3'), ('y3', 'x2'), ('y1', 'x1'), ('y2', 'x1'), ('y3', 'x3'), ('y1', 'x2'), ('y3', 'x1'), ('y2', 'x3')},{('y3', 'x3'): 0, ('y2', 'x2'): -13, ('y1', 'x3'): 0, ('y1', 'x2'): 0, ('y3', 'x1'): 0, ('y1', 'x1'): 0, ('y2', 'x1'): -12, ('y3', 'x2'): 0, ('y2', 'x3'): -1})
    True
    >>> rl[2] == Vec({('y1', 'x3'), ('y2', 'x1'), ('y3', 'x3'), ('y3', 'x2'), ('y1', 'x1'), ('y2', 'x3'), ('y2', 'x2'), ('y1', 'x2'), ('y3', 'x1')},{('y1', 'x1'): -14, ('y1', 'x3'): -1, ('y3', 'x3'): 0, ('y2', 'x2'): 0, ('y3', 'x2'): 0, ('y2', 'x1'): 0, ('y2', 'x3'): 0, ('y1', 'x2'): -15, ('y3', 'x1'): 0})
    True
    >>> rl[3] == Vec({('y1', 'x3'), ('y2', 'x1'), ('y3', 'x3'), ('y3', 'x2'), ('y1', 'x1'), ('y2', 'x3'), ('y2', 'x2'), ('y1', 'x2'), ('y3', 'x1')},{('y1', 'x1'): 0, ('y1', 'x3'): 0, ('y3', 'x3'): 1, ('y2', 'x2'): -15, ('y3', 'x2'): 15,('y2', 'x1'): -14, ('y2', 'x3'): -1, ('y1', 'x2'): 0, ('y3', 'x1'): 14})
    True
    >>> rl[4] == Vec({('y1', 'x3'), ('y2', 'x1'), ('y3', 'x3'), ('y3', 'x2'), ('y1', 'x1'), ('y2', 'x3'), ('y2', 'x2'), ('y1', 'x2'), ('y3', 'x1')},{('y1', 'x1'): -16, ('y1', 'x3'): -1, ('y3', 'x3'): 1, ('y2', 'x2'): 0, ('y3', 'x2'): 17, ('y2', 'x1'): 0, ('y2', 'x3'): 0,('y1', 'x2'): -17, ('y3', 'x1'): 16})
    True
    >>> rl[5] == Vec({('y1', 'x3'), ('y2', 'x1'), ('y3', 'x3'), ('y3', 'x2'), ('y1', 'x1'), ('y2', 'x3'),('y2', 'x2'), ('y1', 'x2'), ('y3', 'x1')},{('y1', 'x1'): 0, ('y1', 'x3'): 0, ('y3', 'x3'): 0, ('y2', 'x2'): -17, ('y3', 'x2'): 0, ('y2', 'x1'): -16, ('y2', 'x3'): -1, ('y1', 'x2'): 0, ('y3', 'x1'): 0})
    True
    >>> rl[6] == Vec({('y1', 'x3'), ('y2', 'x1'), ('y3', 'x3'), ('y3', 'x2'), ('y1', 'x1'), ('y2', 'x3'), ('y2', 'x2'), ('y1', 'x2'), ('y3', 'x1')},{('y1', 'x1'): -18, ('y1', 'x3'): -1, ('y3', 'x3'): 1, ('y2', 'x2'): 0, ('y3', 'x2'): 19, ('y2', 'x1'): 0, ('y2', 'x3'): 0,('y1', 'x2'): -19, ('y3', 'x1'): 18})
    True
    >>> rl[7] == Vec({('y1', 'x3'), ('y2', 'x1'), ('y3', 'x3'), ('y3', 'x2'), ('y1', 'x1'), ('y2', 'x3'),('y2', 'x2'), ('y1', 'x2'), ('y3', 'x1')},{('y1', 'x1'): 0, ('y1', 'x3'): 0, ('y3', 'x3'): 1, ('y2', 'x2'): -19, ('y3', 'x2'): 19, ('y2', 'x1'): -18, ('y2', 'x3'): -1, ('y1', 'x2'): 0, ('y3', 'x1'): 18})
    True
    >>> rl[8] == Vec(D, {('y1', 'x1'):1})
    True
    ''' 
    ...
    for ((x1, x2),(w1, w2)) in zip(corners,coordinates):
      L = L + make_equations(x1, x2, w1, w2)
    return L+[w]
...
def mat_move2board(Y):
    ...
    <BLANKLINE>
    '''
    return Mat(Y.D, {(r,c):v/Y[('y3',c)] for (r,c),v in Y.f.items()})
