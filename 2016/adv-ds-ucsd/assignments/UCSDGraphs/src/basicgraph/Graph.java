...
public abstract class Graph {
	...
	public List<Integer> degreeSequence() {
		...
		{
			degSeq.add(getNeighbors(v).size());
		}
...
//		GraphLoader.createIntersectionsFile("data/maps/san_diego.map", "data/intersections/san_diego.intersections");
		...
		System.out.println("****");
		GraphAdjList graphAdjLst = new GraphAdjList();
		GraphLoader.loadRoadMap("data/maps/san_diego.map", graphAdjLst);
		System.out.println(graphAdjLst.getDistance2(0));
		System.out.println("****");
		GraphAdjMatrix graphAdjMat = new GraphAdjMatrix();
		GraphLoader.loadRoadMap("data/maps/san_diego.map", graphAdjMat);
		System.out.println(graphAdjMat.getDistance2(0));
		System.out.println("****");
