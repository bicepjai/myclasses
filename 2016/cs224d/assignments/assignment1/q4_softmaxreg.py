...
def softmaxRegression(features, labels, weights, regularization = 0.0, nopredictions = False):
    ...
    # refer http://ufldl.stanford.edu/tutorial/supervised/SoftmaxRegression/
    # we from an identity matrix which simulates all the K respective (unique labels)
    # set to 1, then we select the vector representing real label by indexing
    # provided feature labels
