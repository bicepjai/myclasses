...
*/
  ...
  // be very careful implementing this method
  ...
  def mostRetweeted: Tweet = {
    ...
    def maxTweet(twt1: Tweet, twt2: Tweet): Tweet = if(twt1.retweets > twt2.retweets) twt1 else twt2

    def iter: Tweet =
      if(left.isEmpty && right.isEmpty) elem
      else if(left.isEmpty) maxTweet(elem, right.mostRetweeted)
      else if(right.isEmpty) maxTweet(elem, left.mostRetweeted)
      else maxTweet(right.mostRetweeted, maxTweet(left.mostRetweeted, elem))
