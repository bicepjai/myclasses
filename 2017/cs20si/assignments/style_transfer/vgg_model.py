...
def _avgpool(prev_layer, this_layer_name):
    ...
    """
    with tf.variable_scope(this_layer_name) as scope:
        avg_pool = tf.nn.avg_pool(prev_layer, ksize=[1, 2, 2, 1], strides=[1, 2, 2, 1], 
