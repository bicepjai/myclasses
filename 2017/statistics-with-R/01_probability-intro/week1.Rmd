...
arbuthnot <- arbuthnot %>% mutate(boys_prop = boys/total)
ggplot(data = arbuthnot, aes(x = year, y = boys_prop)) + geom_line() + geom_point() 
```
...
ggplot(data=present, aes(x=year, y=boys_prop)) + geom_line() + geom_point()
```
