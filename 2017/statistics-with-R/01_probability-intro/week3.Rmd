...
```{r}
sim_fair_shots <- sample(shot_outcomes, size = 133, replace = TRUE)
fair_streak <- calc_streak(sim_fair_shots)
ggplot(data=fair_streak, aes(x=length)) + geom_histogram(binwidth = 1)
```
