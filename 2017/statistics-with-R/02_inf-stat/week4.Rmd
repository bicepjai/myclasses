...
us12 %>% group_by(response) %>% summarise(n=n()/(1002))
```
...
sqrt(0.0499*0.9501/1002) *  qnorm(0.975)
...
spain10 <- atheism %>% filter(nationality == "Spain")
spain10$year <- as.factor(spain10$year)
spain10 %>%  group_by(year, response) %>% summarise(mean_p = n())


inference(y = response, x = year, data = spain10, statistic = "proportion", type = "ci", method = "theoretical", success = "atheist")

inference(y=response, x = year, data = spain10, statistic = "proportion", type = "ht", method = "theoretical", success = "atheist", alternative="twosided", null=0)
...
```{r us-05-12}
us11 <- atheism %>% filter(nationality == "United States")
us11$year <- as.factor(us11$year)
us11 %>%  group_by(year, response) %>% summarise(mean_p = n())


inference(y = response, x = year, data = us11, statistic = "proportion", type = "ci", method = "theoretical", success = "atheist")

inference(y=response, x = year, data = us11, statistic = "proportion", type = "ht", method = "theoretical", success = "atheist", alternative="twosided", null=0)
```
