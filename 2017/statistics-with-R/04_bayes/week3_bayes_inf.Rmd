...
ggplot(data=nc, aes(y= weight, x = gender)) + 
  geom_boxplot()
...
```{r normal-ci}
ggplot(data=nc, aes(x= weight, color = habit)) + 
  geom_histogram()
...
```{r}
bayes_inference(y = lowbirthweight, data = nc, success = "low", statistic = "proportion", type = "ht", null = 0.075, alternative = "twosided", hypothesis_prior = c(H1=0.25,H2=0.75))
```
